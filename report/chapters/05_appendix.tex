...
\begin{itemize}
    \item \textbf{Mai Trần Tuấn Kiệt:} Thiết kế giao diện tĩnh cho Column (List) và Card bên trong Board. -- \textit{Đang thực hiện}
    \item \textbf{Vũ Lê Đức Anh:} Xây dựng form thêm nhanh List mới và Card mới. -- \textit{Đang thực hiện}
    \item \textbf{Phạm Nguyễn Nguyên Khôi:} Xử lý logic hiển thị dữ liệu từ State lên giao diện Board Detail. -- \textit{Đang thực hiện}
\end{itemize}

\section*{Dự kiến tuần 6 - 9:}
\begin{itemize}
    \item \textbf{Tuần 6-7:} Tích hợp thư viện \texttt{dnd-kit} để xử lý kéo thả Card và List.
