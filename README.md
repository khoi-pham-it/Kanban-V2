...
* **Sprint 3 (State & LocalStorage):** Tích hợp Context API (hoặc dùng ngay State cục bộ cấp cao nhất nếu không quá phức tạp). Viết các hàm thêm, sửa, xóa Board/List/Card và lưu xuống LocalStorage. Đảm bảo F5 trang không mất dữ liệu.
